...
export default {
    ...
    async created() {
        ...
        await this.$store.dispatch('collection/getMenuCategories')
          ...
          await    this.$store.dispatch('collection/getMegaMenuItems')
      await  this.$store.dispatch('collection/getfooterContactInfo')
      await  this.$store.dispatch('collection/getFooterWidgetOneLinks','footer_link_widget_one')
      await  this.$store.dispatch('collection/getFooterWidgetOneLinks','footer_link_widget_two')
     await   this.$store.dispatch('collection/getFooterWidgetOneLinks','footer_link_widget_three')
     await    this.$store.dispatch('collection/getFooterWidgetOneLinks','social_links_widget')
